...
| 14:00 - 15:00 | (_Hands-on_) Batch effects and Confounding factors. Statistical inference. |
| 15:00 - 16:00 | (_Hands-on_) |
...
Inside the `fastqc` directory you will find the report from the `fastqc` program.
